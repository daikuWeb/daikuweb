        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 order-1 md:order-2 mb-8 md:mb-0">
            <Link 
              ...
              className="bg-[#1ee377] p-2 rounded-full hover:bg-opacity-80 transition-all text-white"
              target="_blank"
            ...
            <Link 
              href="mailto:info@daiku.com"
              className="bg-[#1ee377] text-white px-6 py-2 rounded-full hover:bg-opacity-80 transition-all font-medium"
            >
              Contact Us
            </Link>
          </div>
